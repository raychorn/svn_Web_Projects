...
function AddSVGObject(isBrowserEval)
{ var ll=SVGObjects.length;
  SVGObjects[ll]=new SVGObject();
  CurSVGObject=SVGObjects[ll];
  CurSVGObject.idx=ll;
  CurSVGObject.GetSVGDoc = _GetSVGDoc;
  CurSVGObject.GetScene = _GetScene;
}
function _GetSVGDoc()
{ return(document.embeds[this.idx].getSVGDocument());
}
function _GetScene()
