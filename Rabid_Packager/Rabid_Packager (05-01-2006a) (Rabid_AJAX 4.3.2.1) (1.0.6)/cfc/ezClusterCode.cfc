<cfcomponent displayname="ezClusterCode" output="No" extends="commonCode">
	...
	<cffunction name="readSessionFromDb" access="public">
		...
		<cfscript>
			...
			if (isDebugMode()) {
				Request.ezCluster_StatusMsg = '<small style="font-size: 10px; color: blue;"><b>(#_sessID#) URL.sessID = [#bool_IsDefined_URL_sessID#], FORM.sessID = [#bool_IsDefined_FORM_sessID#], Client.sessID = [#bool_IsDefined_Client_sessID#], Session.sessID = [#bool_IsDefined_Session_sessID#]</b></small><br>';
			}
		</cfscript>
