...
<cfoutput>
	...
	<head>
		...
		<cfscript>
			_urlPrefix = CGI.SERVER_NAME;
			_uName = ListFirst(CGI.SCRIPT_NAME, "/");
			if ( (FindNoCase('.cfm', _uName) eq 0) AND (FindNoCase('.htm', _uName) eq 0) ) {
				_urlPrefix = _urlPrefix & '/' & _uName;
			}
			writeOutput(Request.commonCode.html_nocache());
		</cfscript>
<cfif (NOT isDebugMode())>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/disableContextMenu/" type="text/javascript"></script>
</cfif>
		...
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/object_destructor/" type="text/javascript"></script>
		<!--- END! This file MUST be loaded first or bad evil things will happen... --->
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/events/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/CrossBrowserLibrary/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/StylesAndArrays/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/dictionary_obj/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/cf_query_obj/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/nested_array_obj/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/gui_actions_obj/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/ajax_obj/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/ajax_context_obj/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/menu_editor_obj/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/cookie/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/jsCipherCompiler/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/geonosis_obj/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/ajax_support/support/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/dispaySysMessages/" type="text/javascript"></script>
	...
	<noscript>You must enable JavaScript to use this site.</noscript>
		...
		#Request.ezCluster_StatusMsg#

		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/dhtmlLoadScript/" type="text/javascript"></script>

		<!--// load the extensions to the Client/Server Gateway API //-->
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/jsapi_extensions/" type="text/javascript"></script>
		...
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/_init/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/doAJAX_func/" type="text/javascript"></script>

		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/drag-n-drop/drag/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/drag-n-drop/listener/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/drag-n-drop/slider/" type="text/javascript"></script>

		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#_urlPrefix#')#/xjs/packager/javascript/" type="text/javascript"></script>
	...
	<div id="div_ajaxSystem" style="position: absolute;"></div>
		...
		<table id="table_ajaxHelperPanel2" style="width: 700px;" cellpadding="-1" cellspacing="-1">
			<tr>
		...
		<!--
			...
			<cfscript>
				aContentStruct = Request.commonCode.processComplexHTMLContent(Request.commonCode.cfdump(Client, 'Client Scope', false));
				writeOutput("setClientScopeDebugPanelContent('#aContentStruct.htmlContent#');");
			</cfscript>
