<cfcomponent displayname="primitiveCode" output="No">
	...
	<cffunction name="cf_wddx_CFML2JS" access="public" returntype="string">
		<cfargument name="_input_item_" type="any" required="yes">

		<cfset var jsContent = -1>
		<cfwddx action="CFML2JS" input="#_input_item_#" output="jsContent" toplevelvariable="xx$">
		...
		<cfsavecontent variable="content_scopes_debug_panel">
			<cfoutput>
				<table width="100%" cellpadding="-1" cellspacing="-1">
					...
					<tr>
						<td width="20%" align="left" valign="top">
							<div id="div_clientScope_debug_panel"></div>
						</td>
					</tr>
				</table>
			</cfoutput>
