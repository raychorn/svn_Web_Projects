...
//						ezAlert('aDict = [' + aDict + ']');
						...
						if (!!divObj) {
							...
							divObj.innerHTML = '<select id="selection_classBrowser" onchange="alert(\'this.options[this.selectedIndex].text = [\' + this.options[this.selectedIndex].text + \']\' + \', this.options[this.selectedIndex].value = [\' + this.options[this.selectedIndex].value + \']\');" class="textClass" style="width: 400px;"></select>';
