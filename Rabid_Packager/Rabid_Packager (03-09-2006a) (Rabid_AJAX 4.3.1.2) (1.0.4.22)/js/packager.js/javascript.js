...
//	_alert('\n=============================================================');
	...
	//	_alert('sCmd = [' + sCmd + ']');
	//	_alert('(typeof sCmd) = [' + (typeof sCmd) + ']');
		}
		...
		//	_alert('cObj.options[' + cSel + '].text = [' + cObj.options[cSel].text + ']');
		//	_alert('\ncDict = [' + cDict + ']');
...
// +++
		//	_alert('oObj.options[' + oSel + '].value = [' + oObj.options[oSel].value + ']');
		//	_alert('oObj.options[' + oSel + '].text = [' + oObj.options[oSel].text + ']');
		//	_alert('\noDict = [' + oDict + ']');
		...
		//	_alert('GeonosisObj.searchInstancesForObjects(eVal = [' + eVal + '], eKey = [' + eKey + '], false, eNum = [' + eNum + '])');
