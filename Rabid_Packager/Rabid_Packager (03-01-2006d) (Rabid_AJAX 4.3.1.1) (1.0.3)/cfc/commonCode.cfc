<cfcomponent displayname="commonCode" output="No" extends="primitiveCode">
	...
	<cfscript>
		...
		//	writeOutput('<font color="blue"><b><small>A. thePath = [#thePath#], dotPath = [#dotPath#]</small></b></font><br>');
		...
		//	writeOutput('<font color="blue"><b><small>B. thePath = [#thePath#], dotPath = [#dotPath#]</small></b></font><br>');
		...
		function num2Hex(n) {
			return Chr(Asc(Len(hx)) + 32) & _num2Hex(n);
		}
