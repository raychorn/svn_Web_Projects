...
<cfif (NOT isDebugMode())>
		...
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#/#ListFirst(CGI.SCRIPT_NAME, "/")#')#/xjs/events/" type="text/javascript"></script>
	...
	<noscript>You must enable JavaScript to use this site.</noscript>
		...
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#/#ListFirst(CGI.SCRIPT_NAME, "/")#')#/xjs/drag-n-drop/drag/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#/#ListFirst(CGI.SCRIPT_NAME, "/")#')#/xjs/drag-n-drop/listener/" type="text/javascript"></script>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#/#ListFirst(CGI.SCRIPT_NAME, "/")#')#/xjs/drag-n-drop/slider/" type="text/javascript"></script>
