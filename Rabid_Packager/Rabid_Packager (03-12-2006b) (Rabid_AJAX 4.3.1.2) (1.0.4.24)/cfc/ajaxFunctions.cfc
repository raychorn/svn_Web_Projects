<cfcomponent displayname="ajaxFunctions" output="Yes" extends="ajaxCode">
	...
	writeOutput('<b>Request.dbError = [#Request.dbError#]</b><br>');
						...
						case 'performGetGeonosisClasses':
							...
							registerQueryFromAJAX(aGeonosisClassCollector.getDbMetaDataForObjectClassDefs().QCOLUMNS); // this function is used to tell the AJAX system what Query(s) you wish to communicate back to JavaScript - you can register as many Query Objects as you wish... he CF Var named Request.qryData is used to hold an array of Query Objects...
						break;
					}
