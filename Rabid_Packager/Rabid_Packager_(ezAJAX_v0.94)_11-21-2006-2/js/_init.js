function _init(c) {
	...
	oAJAXEngine = AJAXEngine.get$(url_sBasePath + ((url_sBasePath.charAt(url_sBasePath.length - 1) == '/') ? '' : '/') + const_cfm_gateway_process_html, bool_isServerLocal);
	if (!!oAJAXEngine) {
	...
	register_AJAX_function("clearAJAXEnds();");
...
function window_onUnload() {
	...
	AJaxContextObj._remove$();
	AJAXObj._remove$();
	QueryObj._remove$();
	GUIActionsObj._remove$();
	DictionaryObj._remove$();
	NestedArrayObj._remove$();
