...
<cfif 1>
	...
	<cfif 0>
		...
		<tr>
			<td>
				<button name="btn_getContents" id="btn_getContents" class="buttonMenuClass" onclick="this.disabled = true; oAJAXEngine.doAJAX('performGetGeonosisClasses', 'handle_ezAJAXCallBack'); return false;" style="cursor:hand; cursor:pointer;"><img src="images/Geonosis/32x32/small-icons.gif" title="#cf_const_Objects_symbol# - Get Objects" border="0"></button>
			</td>
		</tr>
	</table>
