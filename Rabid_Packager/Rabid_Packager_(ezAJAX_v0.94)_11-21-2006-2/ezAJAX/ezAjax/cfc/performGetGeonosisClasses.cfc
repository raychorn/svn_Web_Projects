	...
	<cfsavecontent variable="html_masterBrowser">
		<cfoutput>
			<table width="400" border="1" cellpadding="-1" cellspacing="-1">
				<tr>
					<td>
						<button name="btn_getContents" id="btn_getContents" class="buttonMenuClass" onclick="this.disabled = true; oAJAXEngine.doAJAX('performGetGeonosisClasses', 'handle_ezAJAXCallBack'); return false;" style="cursor:hand; cursor:pointer;"><img src="images/Geonosis/32x32/small-icons.gif" border="0" title="#cf_const_Objects_symbol# - Get Objects"></button>
					</td>
				</tr>
				<tr>
