...
<cfif 0>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#/#ListFirst(CGI.SCRIPT_NAME, "/")#/cfcontent_js.cfm?jsName=js/ajax_support.js/support.js')#" type="text/javascript"></script>
<cfelse>
...
<cfif 0>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#/#ListFirst(CGI.SCRIPT_NAME, "/")#/cfcontent_js.cfm?jsName=js/packager.js/javascript.js')#" type="text/javascript"></script>
<cfelse>
		<script language="JavaScript1.2" src="#Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#/#ListFirst(CGI.SCRIPT_NAME, "/")#')#/xjs/packager/packager/" type="text/javascript"></script>
</cfif>		
