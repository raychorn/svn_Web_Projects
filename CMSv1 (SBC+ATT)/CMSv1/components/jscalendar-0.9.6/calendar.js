...
Calendar.prototype.create = function (_par) {
	...
	if (this.showsTime) {
		...
		(function(){
			...
			// BEGIN: This mod allows the outside world to "see" the user selectable time widgets...
			cal._time_widget_hh = H;
			cal._time_widget_mm = M;
			cal._time_widget_ap = AP;
			// END! This mod allows the outside world to "see" the user selectable time widgets...
