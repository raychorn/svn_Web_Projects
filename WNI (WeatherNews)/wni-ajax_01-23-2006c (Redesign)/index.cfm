...
<cfset _menu_editor_core_js = "#_js_path#menu_editor_core.js">
<cfset _menu_editor_admin_js = "#_js_path#menu_editor_admin.js">

<cfset _support_js = "#_js_path#support.js">
...
<cfoutput>
	...
	<head>
		...
		<script language="JavaScript1.2" src="#_menu_editor_core_js#" type="text/javascript"></script>
...
// +++
		...
		//	rebuildMenu(menuArray, false, '#CGI.SCRIPT_NAME#');
		// -->
		</script>
