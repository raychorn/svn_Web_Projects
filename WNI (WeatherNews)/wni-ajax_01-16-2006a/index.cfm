	...
	<body onload="window_onload()" onunload="window_onUnload()">
		...
		<!--
			function queueUp_AJAX_Sessions() {
				var pQueryString = '';
			//	register_jsapi_function("execJSAPI_func('getGroupNames', 'displayTopLevelMenuNames(" + oGateway.js_global_varName + ")', 'spanName', '#const_groupNameRecord_symbol#', 'col1_keyName', 'ID', 'col2_keyName', 'LAYERGROUPNAME', 'div_name', 'div_contents2', 'editor_title_bar', 'Group Names', 'cfm_add_cmd', 'addGroupName', 'cfm_save_cmd', 'saveGroupName', 'cfm_drop_cmd', 'dropGroupName');");
				...
				oGateway.addNamedContext('Context1', pQueryString);
