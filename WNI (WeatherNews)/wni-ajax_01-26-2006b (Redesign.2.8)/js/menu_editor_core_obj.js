...
menuEditorCoreObj = function(id, div_menuBrowserID, menuBrowserID, _menu_textColor, _outerWidth) {
	...
	this.guiHTML = menuEditorCoreObj.defaultGUI(this, _menu_textColor, _outerWidth); 	// create the default GUI - this default GUI can be overridden with another that specifies the same DOM Object ID's...
};

menuEditorCoreObj.instances = [];

menuEditorCoreObj.getInstance = function(_div_menuBrowserID, _menuBrowserID, menuTextColor, outerWidth) {
	...
	if(instance == null) {
		instance = menuEditorCoreObj.instances[menuEditorCoreObj.instances.length] = new menuEditorCoreObj(menuEditorCoreObj.instances.length, _div_menuBrowserID, _menuBrowserID, menuTextColor, outerWidth);
	}
	return instance;
};
...
menuEditorCoreObj.defaultGUI = function(menuEditorObj, _site_menu_text_color, _outerTableWidth) {
	var _html = '';
