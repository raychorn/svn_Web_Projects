					...
					if (!!qData) {
						...
						if (!bool_isAnyErrorRecords) {
							...
							if (!!cObj) {
								...
								global_htmlStream = '<table width="100%" cellpadding="5" cellspacing="-1"><tr><td valign="top" align="left">' + displayEditorControlPanel() + '</td><td valign="top" align="center">' + _html + '</td></tr></table>';
