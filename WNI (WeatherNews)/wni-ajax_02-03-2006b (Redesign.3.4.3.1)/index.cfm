...
// +++
								...
								global_menuEditorObj.onDeleteMenuItem = function (brObj, bcutObj) {
									var oAR = [];
								...
								global_menuEditorObj.onClickMenuItem = function (brObj) {
									selected_MENUUUID = brObj.options[brObj.selectedIndex].value;
									_isParent = ((oMenuDict.getValueFor(selected_MENUUUID) == null) ? false : true);
								...
								currentParentSubMenu_id = '';
								refreshMenuForLevel('-1');								
