			...
			function displayMenuEditor(qObj) {
				...
				function displayRecord(_ri, _dict, _rowCntName, queryObj) {
					...
					try {
						...
						//	_alert('A. _PARENT_ID = [' + _PARENT_ID + ']' + ', _PARENTUUID = [' + _PARENTUUID + ']' + ', _PROMPT = [' + _PROMPT + ']' + ', _DISPORDER = [' + _DISPORDER + ']' + '\n' + global_menuEditorObj.menuArray);
						...
						//	_alert('B. _PARENT_ID = [' + _PARENT_ID + ']' + ', _PARENTUUID = [' + _PARENTUUID + ']' + ', _PROMPT = [' + _PROMPT + ']' + ', _DISPORDER = [' + _DISPORDER + ']' + ', brObj.selectedIndex = [' + brObj.selectedIndex + ']');
