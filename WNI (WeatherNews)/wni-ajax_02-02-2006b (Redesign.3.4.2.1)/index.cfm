									...
									function cutItemsFromClipBoard(_MENUUUID, _PARENTID) {
										...
										if (_PARENTID != null) {
											...
											if (selected_container != null) {
												...
												new_container = [];
											//	_alert('\nselected_container = [' + selected_container + ']' + ', selected_container.length = [' + selected_container.length + ']');
											...
											//	_alert('\nnew_container = [' + new_container + ']' + ', new_container.length = [' + new_container.length + ']');
