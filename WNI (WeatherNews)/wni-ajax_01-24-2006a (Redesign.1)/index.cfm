...
<cfset _menu_editor_admin_js = "#_js_path#menu_editor_admin.js">
...
// +++
													...
													<tr>
														<td>
															<div id="_menu_submenu_additor_button" style="display: inline;">
																...
																<input type="button" #_tooltips_# value="Add Empty#Request.const_Cr#SubMenu" style="font-size: 9px;" title="Click this button to add a SubMenu Item.  SubMenu Items may contain one or more Menu Items and are used to extend the menu horizontally whereas Menu Items extend the Menu vertically." onClick="var brObj = getGUIObjectInstanceById('menu_browser'); if (brObj != null) { processMenuSubMenuAdditor(brObj) } return false;">
															</div>
														</td>
													</tr>
													<tr>
									...
									<table cellpadding="-1" cellspacing="-1">
										<tr>
															...
															<table width="100%" cellpadding="-1" cellspacing="-1">
																<tr>
																	...
																	<td width="50%" align="right">
																		...
																		<input type="button" #_tooltips_# id="menu_browse_out" value="Close#Request.const_Cr#Sub Menu" disabled style="font-size: 9px;" title="Click this button to Close a SubMenu that was previously opened." onClick="var brObj = getGUIObjectInstanceById('menu_browser'); if (brObj != null) { processMenuBrowseOut(brObj) } return false;">
																	</td>
																</tr>
															</table>
														</td>
											...
											<td align="center" valign="top">
												...
												<input type="button" #_tooltips_# disabled value="Cut to#Request.const_Cr#Clipboard" style="font-size: 9px;" title="Click this button to Cut a Menu Item or SubMenu Item to the ClipBoard. This function allows you to reorder the Menu; once a Menu Item or SubMenu is on the ClipBoard it may be Moved back to the Menu in a different position or into a different SubMenu container." onClick="var brObj = getGUIObjectInstanceById('menu_browser'); if (brObj != null) { processMenuCutToClipboard(brObj) } return false;">
												<cfif 0>
													<br><br>
													<cfset _tooltips_ = "id=menu_copy_to_clipboard">
													<input type="button" #_tooltips_# disabled value="Copy to#Request.const_Cr#Clipboard" style="font-size: 9px;" title="Click this button to Copy a Menu Item or SubMenu Item to the ClipBoard. This function allows you to clone a Menu or SubMenu Item to make a copy of the item being copied to the ClipBoard; once a Menu Item or SubMenu is on the ClipBoard it may be Moved back to the Menu in a different position or into a different SubMenu container." onClick="var brObj = getGUIObjectInstanceById('menu_browser'); if (brObj != null) { processMenuCopyToClipboard(brObj) } return false;">
												<cfelse>
													<br><br>
		...
		<script language="JavaScript1.2" type="text/javascript">
		<!--
			global_menuEditorObj = menuEditorCoreObj.getInstance();
			...
			if (dObj != null) {
				...
				if (bObj != null) {
					populateSelectWithMenu(bObj, global_menuEditorObj.menuArray);
				}
			}
			...
			global_menuItemEditorsList = '';
			
			const_cancelButton_symbol = '#_cancelButton_symbol#';
			const_listOfRequiredSpecialPages = '';
			const_currentPage_symbol = '#_currentPage_symbol#';

			const_subMenu_symbol = '#_menuSubMenuURL_symbol#';
			const_subMenuEnds_symbol = '#_menuSubMenuEndsURL_symbol#';

			const_menuSubMenuEndsURL_symbol = '#_menuSubMenuEndsURL_symbol#';
