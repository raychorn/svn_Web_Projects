...
function retrieveMenuAtLevel(mm, stack, i) {
	...
	global_menuEditorObj._menu_in_browser = c;
	return c;
}
...
function performMenuPasteAtLevel(value, offset) {
	if (!!global_menuEditorObj._menu_in_browser) {
		insertArrayItem(global_menuEditorObj._menu_in_browser,value,offset);
	}
	return global_menuEditorObj._menu_in_browser;
}

function performMenuCutAtLevel(offset) {
	if (!!global_menuEditorObj._menu_in_browser) {
		removeArrayItem(global_menuEditorObj._menu_in_browser,offset);
	}
	return global_menuEditorObj._menu_in_browser;
}
...
function isClipboardActuallyEmpty() {
	...
	if (!!clipObj) {
		return ( (clipObj.options.length == 1) && (clipObj.options[0].text.toUpperCase() == global_menuEditorObj.const_ClipboardEmpty_symbol.toUpperCase()) );
	}
	return false;
}
...
function _processMenuCutToClipboard(brObj, bool_copy_to_clipboard) {
	...
	if ( (!!brObj) && (!!clipObj) && (!!bcutObj) && (!!bcopyObj) && (!!bcpasteObj) && (!!pgObj) ) {
		...
		if (bool_copy_to_clipboard == true) {
			...
			global_menuEditorObj._menu_clipboard[i] = v;
...
function processClipboardPasteToMenu(clipObj) {
	...
	if ( (brObj != null) && (clipObj != null) && (bcpasteObj != null) && (bcremoveObj != null) ) {
		if (clipObj.selectedIndex != -1) {
			var v = global_menuEditorObj._menu_clipboard[clipObj.selectedIndex];
...
function processClipboardRemoveSelected(clipObj) {
	...
	if ( (brObj != null) && (clipObj != null) && (bcpasteObj != null) && (bcremoveObj != null) ) {
		...
		if (sel != -1) {
			...
			removeArrayItem(global_menuEditorObj._menu_clipboard,sel);
			...
			if (clipObj.options.length == 0) {
				optObj = new Option(global_menuEditorObj.const_ClipboardEmpty_symbol, global_menuEditorObj.const_ClipboardEmpty_value);
...
function processSelectedClipboardItem(clipObj) {
	...
	if ( (brObj != null) && (clipObj != null) && (bcpasteObj != null) && (bcremoveObj != null) ) {
		...
		if (_text.toUpperCase() == global_menuEditorObj.const_ClipboardEmpty_symbol.toUpperCase()) {
			bcremoveObj.disabled = true;
		} else {
			bcremoveObj.disabled = false;
		}
...
function processCancelMenuItemEditor() {
	...
	if ( (eObj != null) && (ebutObj != null) && (abutObj != null) && (asbutObj != null) && (clipObj != null) && (brObj != null) && (hcpObj != null) && (hcpObj2 != null) ) { 
		...
		var a = -1;
		while (global_menuEditorObj._menu_widgets_stack.length > 0) {
			a = global_menuEditorObj._menu_widgets_stack.pop();
		...
		var pgObj = getGUIObjectInstanceById('menu_item_editor_pageList');
		if (pgObj != null) {
			while (global_menuEditorObj._stack_remember_to_remove_from_pglist.length > 0) {
				a = global_menuEditorObj._stack_remember_to_remove_from_pglist.pop();
				for (var i = 0; i < pgObj.options.length; i++) {
...
function processSaveMenuItemEditor() {
	...
	if ( (epObj != null) && (brObj != null) && (pgObj != null) && (hObj != null) ) {
		...
		if (c != null) {
			...
			if ( (global_menuEditorObj.isAddingMenuItem == false) && (global_menuEditorObj.isAddingMenuSubMenu == false) ) {
				var v = c[sel + offset];
				...
				global_menuEditorObj.populateSelectWithMenu(brObj, c);
			//	rebuildMenu(global_menuEditorObj.menuArray, false);
			} else if (global_menuEditorObj.isAddingMenuItem == true) {
				var _url = ' ';
				var _target = ' ';
				if ( (!!iObj) && (iObj.checked == true) ) {
					_url = const_cgi_script_name_symbol + global_menuEditorObj.const_currentPage_symbol + pgObj.options[pgObj.selectedIndex].text.trim();
			...
			} else if (global_menuEditorObj.isAddingMenuSubMenu == true) {
...
function refreshUrlType(_url) {
	var tlObj = getGUIObjectInstanceById(global_menuEditorObj.const_menu_url_typelist);
	if (tlObj != null) {
		var val = '';
...
function _processMenuItemEditor(brObj) {
	...
	if ( (brObj != null) && (ebObj != null) && (abObj != null) && (asObj != null) && (edObj != null) && (epObj != null) && (clipObj != null) && (pgObj != null) && (hObj != null) && (hcpObj != null) && (hcpObj2 != null) ) {
		...
		if (c != null) {
			...
			if ( (global_menuEditorObj.isAddingMenuItem == true) || (global_menuEditorObj.isAddingMenuSubMenu == true) ) {
				...
				if (_url.toUpperCase().indexOf(global_menuEditorObj.const_currentPage_symbol.trim().toUpperCase()) != -1) {
					...
					if (_url_toks.length > 1) {
						...
						if (_url_toks2.length > 1) {
							...
							insertArrayItem(opts,optObj,0);
							global_menuEditorObj._stack_remember_to_remove_from_pglist.push(optObj);
							for (var i = 0; i < opts.length; i++) {
								pgObj.options[i] = opts[i];
							}
			...
			if (global_menuEditorObj.isAddingMenuItem == true) {
				...
				_refreshUrlType();
			} else if ( (global_menuEditorObj.isAddingMenuSubMenu == true) || (_isSubMenu == true) ) {
				...
				if ( (global_menuEditorObj.isAddingMenuSubMenu == true) || (_isSubMenu == true) ) {
					if (!!iObj) iObj.checked = false;
					if (!!eObj) eObj.checked = false;
				} else if (_isSubMenu == false) {
					epObj.value = '';
				}
			} else if ( (global_menuEditorObj.isAddingMenuItem == false) && (global_menuEditorObj.isAddingMenuSubMenu == false) ) {
			...
			if ( (b1Obj != null) && (b2Obj != null) && (b3Obj != null) && (b4Obj != null) && (b5Obj != null) && (r1Obj != null) && (r2Obj != null) ) {
				...
				a[0] = b1Obj.id;
				a[1] = b1Obj.disabled;
				global_menuEditorObj._menu_widgets_stack.push(a);
...
function processMenuSubMenuAdditor(brObj) {
	...
	global_menuEditorObj.isAddingMenuSubMenu = true;
	global_menuEditorObj.isAddingMenuItem = false;
...
function processMenuItemAdditor(brObj) {
	...
	global_menuEditorObj.isAddingMenuItem = true;
	global_menuEditorObj.isAddingMenuSubMenu = false;
	return _processMenuItemEditor(brObj);
}
...
function refreshMenuItemEditorSaveButton() {
	var iObj = getGUIObjectInstanceById('_menu_item_editor_internal');
	var pgObj = getGUIObjectInstanceById('menu_item_editor_pageList');
	var sbObj = getGUIObjectInstanceById(global_menuEditorObj.const_menu_item_editor_saveButton);
