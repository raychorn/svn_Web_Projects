	...
	<body onload="window_onload()" onunload="window_onUnload()">
		...
		<!--//
			...
			function execJSAPI_func(cmd) {
				var sValue = '&cfm=' + cmd + '&AUTH_USER=#Request.AUTH_USER#';
				...
				<td align="center">
					<table width="100%" cellpadding="-1" cellspacing="-1">
						<tr>
							...
							<td align="center">
								<button name="btn_1" id="btn_1" class="buttonMenuClass" onclick="execJSAPI_func('getTopLevelMenuNames.cfm'); return false;">[Test]</button>
							</td>
						</tr>
					</table>
				</td>
