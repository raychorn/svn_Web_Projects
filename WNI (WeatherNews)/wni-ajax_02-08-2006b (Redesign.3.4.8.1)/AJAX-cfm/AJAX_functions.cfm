...
<cfscript>
	...
	switch (Request.qryStruct.cfm) {
		case 'updateLayerData':
			...
			//	qObj = QueryNew('id, msg');
			//	QueryAddRow(qObj, 1);
			//	QuerySetCell(qObj, 'id', qObj.recordCount, qObj.recordCount);
			//	QuerySetCell(qObj, 'msg', '_colName = [#_colName#], _recId = [#_recId#]', qObj.recordCount);
	
			//	Request.commonCode.registerQueryFromAJAX(qObj);
				...
				Request.commonCode.safely_execSQL('Request.qGetLayerDataSchema', Request.INTRANET_DS, "sp_columns @table_name = 'dbo.AvnLayer', @column_name = '#_colName#', @table_owner = 'dbo'");
