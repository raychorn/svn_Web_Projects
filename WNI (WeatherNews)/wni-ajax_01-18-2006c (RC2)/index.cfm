...
// +++
			...
			function displayMenuGroupNames(qObj) {
				...
				//	alert('displayRecord(_ri = [' + _ri + '], _dict = [' + _dict + '], _rowCntName = [' + _rowCntName + '])' + ', _ID = [' + _ID + ']' + ', _MENU_ID = [' + _MENU_ID + ']' + ', _GROUP_ID = [' + _GROUP_ID + ']' + ', _MENUNAME = [' + _MENUNAME + ']' + ', _LAYERGROUPNAME = [' + _LAYERGROUPNAME + ']');
