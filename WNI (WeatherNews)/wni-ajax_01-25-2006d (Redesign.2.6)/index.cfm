	...
	<body onload="window_onload()" onunload="window_onUnload()">
		...
		<!--
			...
			//	register_jsapi_function(jsCode);
				...
				jsCode += "oGateway.addNamedContext('#const_menuEditorRecord_symbol#', pQueryString); ";
				jsCode += "global_maxRecsPerPage['#const_menuEditorRecord_symbol#'] = 10; ";
				jsCode += "execJSAPI_func('getMenuEditorContents', 'displayMenuEditor(" + oGateway.js_global_varName + ")'); ";
				register_jsapi_function(jsCode);
					...
					if (!!qData) {
						...
						//	_alert(oParms);
							...
							if (!!cObj) {
								...
								global_menuEditorObj = menuEditorCoreObj.getInstance('div_menu_browser', 'menu_browser', '#_site_menu_background_color#', '#_site_menu_text_color#', 400);
