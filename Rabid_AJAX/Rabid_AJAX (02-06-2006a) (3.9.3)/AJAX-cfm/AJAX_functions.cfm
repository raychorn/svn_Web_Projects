...
<cfsavecontent variable="html_theForm">
	<cfoutput>
		<form>
			<TEXTAREA class="input_1" rows="8" name="kodeawal" id="kodeawal" cols="70" wrap="virtual"></TEXTAREA> 
			<TEXTAREA class="input_1" rows="8" name="hasil" id="hasil" cols="70" wrap="virtual"></TEXTAREA>
			...
			<input class="input_stats" type="text" name="panjangasli" size="11" />
			<input class="input_stats" type="text" name="pertambahan" size="11" />
			<input class="input_stats" type="text" name="panjangenkripsi" size="11" />
		</form>
	</cfoutput>
</cfsavecontent>
