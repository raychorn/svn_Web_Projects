...
<cfsavecontent variable="html_theForm">
	<cfoutput>
		<form id="form_enkrip">
			<TEXTAREA rows="8" name="kodeawal" id="kodeawal" cols="70" wrap="virtual"></TEXTAREA> 
			<TEXTAREA readonly rows="8" name="hasil" id="hasil" cols="70" wrap="virtual"></TEXTAREA>
			<input type="hidden" name="parameter" value="2" /> 
			<br><span class="textClass">Input Length:&nbsp;</span><input type="text" id="form_enkrip_input_length" size="11" />
			<br><span class="textClass">Diff Length:&nbsp;</span><input type="text" name="form_enkrip_diff_length" size="11" />
			<br><span class="textClass">Enkrip Length:&nbsp;</span><input type="text" name="form_enkrip_enkrip_length" size="11" />
		</form>
	</cfoutput>
</cfsavecontent>
...
<cfscript>
	switch (Request.qryStruct.cfm) {
		...
		case 'performEmailTest':
			Request.commonCode.safely_cfmail('rabid_one@contentopia.net', 'raychorn@sbcglobal.net', 'Re: Testing', 'Testing 1.2.3.');
