...
<cfscript>
	aStruct = StructNew();
	aStruct.bool_using_xmlHttpRequest = bool_using_xmlHttpRequest;
	aStruct.bool_using_xmlHttpRequest_viaGET = bool_using_xmlHttpRequest_viaGET;
	aStruct.bool_using_xmlHttpRequest_viaPOST = bool_using_xmlHttpRequest_viaPOST;
	aStruct.bool_canDebugHappen = bool_canDebugHappen;
//	aStruct._QUERY_STRING = _QUERY_STRING;
	Request.commonCode.beginAJAX(aStruct);
</cfscript>
