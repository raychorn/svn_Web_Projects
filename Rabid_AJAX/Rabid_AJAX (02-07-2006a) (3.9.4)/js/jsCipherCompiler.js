...
jsCipherCompilerObj.prototype = {
	...
	enkrip : function(formnya) {
		...
		*/
		...
		<!-- Hitung hasilnya -->
		this.input_length = formnya.kodeawal.value.length;
		this.enkrip_length = formnya.hasil.value.length;
		this.diff_length = formnya.hasil.value.length-formnya.kodeawal.value.length;
	},
	init : function() {
		return this;
	},
